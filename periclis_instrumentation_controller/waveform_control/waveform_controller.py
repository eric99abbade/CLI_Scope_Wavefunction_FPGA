...
# @date 24/04/2024
###############################################################################
from periclis_instrumentation_controller.waveform_control.waveform_reader import WaveformInfoReader
from periclis_instrumentation_controller.waveform_control.waveform_writer import WaveformWriter
...
import logging 
class waveform_controller(WaveformInfoReader, WaveformWriter):
    ...
    def __init__(self, resource=None): 
        ...
        self.waveform_generator = self.rm.open_resource(resource) 
        ...
        self.waveform_generator.timeout = (float(self.standard_timeout))*1000 #Sets the initial timeout.
        WaveformInfoReader.__init__(self, self.waveform_generator)
        WaveformWriter.__init__(self, self.waveform_generator)
        print_blue("Variables used for changing the parameter values will be rounded according to the decimal places defined in the data/waveform_config.csv file.")

    def list_services(self) -> dict:
        return get_services(controler_name='WaveformController')
